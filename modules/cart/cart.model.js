(function () {
	...
	CartModel.$inject = ['$http', '$q', '$timeout', 'CacheFactory', 'AppAuthenticationService', 'API', 'ENUM'];

	function CartModel($http, $q, $timeout, CacheFactory, AppAuthenticationService, API, ENUM) {
		var service = {};
